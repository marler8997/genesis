...
def set_interpreter(filename, hdr, mem, new_interp):
    ...
    print("[DEBUG] changinge interpreter with {} program headers...".format(hdr.phnum))
    ...
    for phindex in range(0, hdr.phnum):
        ...
        if type == PT_INTERP:
            print("[DEBUG] found PT_INTERP section!")
            phoff += 4
            ...
            #print("[DEBUG] current_interp is '{}'".format(current_interp))
